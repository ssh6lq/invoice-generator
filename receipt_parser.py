...
SYSTEM_PROMPT = (
    ...
    "- 카드사 앱 결제 내역 화면(이용금액·승인번호 등 표 형식)처럼 상호명이 화면 최상단 "
    "헤더에 크게 표시되고, '가맹점 정보' 섹션은 하단에 따로 있거나 접혀 있는 경우: "
    "헤더의 상호명을 store 에 채우고, merchant_*/seller_* 는 모두 null 로 두세요. "
    "(예: 최상단에 '우아한형제들'이 크게 보이면 → store='우아한형제들')\n"
